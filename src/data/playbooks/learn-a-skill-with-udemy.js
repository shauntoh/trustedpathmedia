const playbook = {
  ...
  goal: 'Pick the right Udemy course, complete it with real retention, and ship one portfolio project that proves the skill to an employer or client.',
  earningPotential: 'Skill-dependent · directly increases billable rate or employability — $10–$8,000/mo uplift depending on the skill',
  difficulty: 'Beginner',
