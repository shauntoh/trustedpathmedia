const playbook = {
  slug: 'post-30-videos-with-invideo-fiverr',
  title: 'Post 30 videos a month with InVideo + Fiverr',
  tagline:
  ...
  goal: 'Create and publish 30 short-form videos per month using a repeatable system powered by AI and outsourcing, without needing to edit or post everything yourself.',
  earningPotential: '$0–$5,000+/month long-term · YouTube ads, affiliate links, and digital products · depends heavily on niche and consistency',
  difficulty: 'Beginner',
  timeRequired: '2–4 hours (setup), then ~1–2 hours/week',
  publishedAt: '2026-05-03',
  toolsUsed: [
    {
      name: 'InVideo AI',
      role: 'AI video creation — paste a script, get a finished video',
      reviewSlug: 'invideo',
      affiliateUrl: 'https://invideo.sjv.io/R062Xb',
    },
    {
      name: 'Fiverr',
      role: 'Freelance marketplace for editing, captions, and scheduling',
      reviewSlug: 'fiverr',
