const entry = {
  ...
  date: '2026-04-30',
  title: 'Midjourney v8.1 Ships With Native 2K Images and 5x Faster Generation',
  summary:
    'Midjourney released v8.1 across its web app and Discord on April 30, delivering native 2048x2048 HD output without a separate upscale step and standard job rendering 4–5× faster than earlier versions.',
  body:
