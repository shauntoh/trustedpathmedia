const entry = {
  slug: '2026-04-30-midjourney-v8-1',
  date: '2026-04-30',
  title: 'Midjourney v8.1 Ships With Native 2K Images and 5× Faster Generation',
  summary:
    'Midjourney released v8.1 across its web app and Discord on April 30, delivering native 2048×2048 HD output without a separate upscale step and standard job rendering 4–5× faster than earlier versions.',
  body:
    'HD-by-default removes the upscaling step that used to sit between first draft and usable asset — designers and content creators now get print-ready resolution on the initial render, which meaningfully tightens the iteration loop when working at volume. Improved text rendering, including accurate quoted text in prompts, is the less-heralded change with the bigger practical impact: marketing and product teams can finally generate mockups with real copy rather than placeholder gibberish, reducing downstream Photoshop cleanup. The 4–5× speed improvement changes the credit economics for high-volume users — you can run more variations in the same credit window, which either cuts cost or buys more creative exploration depending on how you work. Where v8.1 still trails is brand consistency: Adobe Firefly's custom model training lets agency teams anchor output to a specific visual identity, something Midjourney has no direct equivalent for yet.',
