const entry = {
  ...
  date: '2026-03-30',
  title: 'Zapier Agents Get AI Guardrails for Safer Automated Workflows Across 9,000+ Apps',
  summary:
    'Zapier launched AI Guardrails on March 30 2026 -- a built-in safety layer for its Agents feature that checks outputs and routes ambiguous actions for human review before executing across its 9,000+ app integrations.',
  body:
